...
<div class="grid grid-cols-2 gap-3 mt-4 px-8">
  <div class="feature-card">
    ...
    <div>
      <h3 class="text-base font-bold mb-0.5">AI Video Avatars That Feel Human</h3>
      <p class="text-gray-600 text-xs">Conversational AI that mimics expert-level support agents, not robotic scripts. Just like being on a Zoom call with a Pro</p>
    </div>
  </div>
  ...
  <div class="feature-card">
    ...
    <div>
      <h3 class="text-base font-bold mb-0.5">Sales Demos 24/7</h3>
      <p class="text-gray-600 text-xs">Users want to make buying decisions in their own time. Our avatars know the art of sales, while being helpful 24/7</p>
    </div>
  </div>
  ...
  <div class="feature-card">
    ...
    <div>
      <h3 class="text-base font-bold mb-0.5">Native SaaS Integration</h3>
      <p class="text-gray-600 text-xs">Embedded directly into your product interface where users need help most or Sales demo's right on your home page</p>
    </div>
  </div>
  ...
  <div class="feature-card">
    ...
    <div>
      <h3 class="text-base font-bold mb-0.5">Simple Setup</h3>
      <p class="text-gray-600 text-xs">Just upload a Loom video of your product demo and grant platform access - we handle the rest</p>
    </div>
  </div>
</div>
