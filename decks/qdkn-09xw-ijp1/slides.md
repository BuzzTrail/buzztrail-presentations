...
<div class="grid grid-cols-2 gap-4 mt-6 px-8">
  <div class="feature-card">
    <div class="feature-icon">
      <carbon-watson class="w-6 h-6" />
    </div>
    <h3 class="text-lg font-bold mb-1">AI Video Avatars That Feel Human</h3>
    <p class="text-gray-600 text-sm">Conversational AI that mimics expert-level support agents, not robotic scripts. Just like being on a Zoom call with a Pro</p>
  </div>

  <div class="feature-card">
    <div class="feature-icon">
      <carbon-video class="w-6 h-6" />
    </div>
    <h3 class="text-lg font-bold mb-1">Sales Demos 24/7</h3>
    <p class="text-gray-600 text-sm">Users want to make buying decisions in their own time. Our avatars know the art of sales, while being helpful 24/7</p>
  </div>

  <div class="feature-card">
    <div class="feature-icon">
      <carbon-code class="w-6 h-6" />
    </div>
    <h3 class="text-lg font-bold mb-1">Native SaaS Integration</h3>
    <p class="text-gray-600 text-sm">Embedded directly into your product interface where users need help most or Sales demo's right on your home page</p>
  </div>

  <div class="feature-card">
    <div class="feature-icon">
      <carbon-time class="w-6 h-6" />
    </div>
    <h3 class="text-lg font-bold mb-1">Simple Setup</h3>
    <p class="text-gray-600 text-sm">Just upload a Loom video of your product demo and grant platform access - we handle the rest</p>
  </div>
</div>
